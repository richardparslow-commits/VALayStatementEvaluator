...
HOSTILE_ENVIRONMENT: dict[str, str] = {
    ...
    "VA_LSE_EXTRACTOR_RUNNER": "hostile-runner",
    "VA_LSE_EXTRACTOR_TIMEOUT_SECONDS": "1",
    ...
    "VA_LSE_DOCX_MAX_INTERNAL_FILE_BYTES": "10",
    "VA_LSE_DOCX_MAX_INTERNAL_FILE_COUNT": "1",
    "VA_LSE_DOCX_MAX_TOTAL_UNCOMPRESSED_BYTES": "20",
    ...
    "VA_LSE_LLM_MAX_RPM": "1",
    "VA_LSE_LLM_MIN_INTERVAL_SECONDS": "60",
    "VA_LSE_LLM_RETRY_AFTER_MAX_SECONDS": "1",
    "VA_LSE_LLM_STALL_WATCHDOG_MULTIPLIER": "0.1",
    ...
    "VA_LSE_AUDIT_BACKUP_LOCK_STALE_SECONDS": "1",
    ...
    "VA_LSE_JOB_QUEUE_CLAIM_TIMEOUT_SECONDS": "1",
    "VA_LSE_JOB_QUEUE_INLINE_MAX_BYTES": "10",
    "VA_LSE_JOB_QUEUE_MAX_PAYLOAD_BYTES": "10",
    "VA_LSE_BLOB_STORE": "none",
    "VA_LSE_BLOB_DIR": "/tmp/va-lse-hostile-blobs",
    "VA_LSE_SHARED_CACHE_URL": "https://hostile.invalid",
    "VA_LSE_SHARED_CACHE_TOKEN": "hostile-token",
    "VA_LSE_SHARED_CACHE_TIMEOUT_SECONDS": "0.1",
    "VA_LSE_SHARED_CACHE_LOCAL_MAXSIZE": "1",
